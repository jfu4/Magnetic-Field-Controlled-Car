...
; This file was generated Mon Apr 03 13:40:59 2023
;--------------------------------------------------------
$name ADC
$optc51 --model-small
$printf_float
...
;	ADC.c:204: "Compiled: %s, %s\n\n",
	...
	add	a,#0xf4
	mov	sp,a
;	ADC.c:207: InitPinADC(1, 6); // Configure P2.2 as analog input
...
;	ADC.c:213: while(1)
L009002?:
;	ADC.c:216: v[0] = Volts_at_Pin(QFP32_MUX_P1_6);
	mov	dpl,#0x0C
	lcall	_Volts_at_Pin
	mov	r2,dpl
	mov	r3,dph
...
;	ADC.c:220: printf ("V@P1.6=%7.5fV, V@P2.3=%7.5fV, V@P2.4=%7.5fV, V@P2.5=%7.5fV\r", v[0], v[1], v[2], v[3]);
	push	ar2
	push	ar3
	push	ar4
	push	ar5
...
__str_4:
	...
	db 0x00
__str_5:
	db 'V@P1.6=%7.5fV, V@P2.3=%7.5fV, V@P2.4=%7.5fV, V@P2.5=%7.5fV'
	db 0x0D
	db 0x00
